function trello(){
	...
	contenedorGuardarLista.setAttribute('class', 'guardarLista col-xs-12 col-sm-12 col-md-12 col-lg-2');
	...
	botonAgregarLista.addEventListener('click', function(){
		...
		columnaOrden.setAttribute('class', 'col-xs-12 col-sm-12 col-md-12 col-lg-2 distancia');
